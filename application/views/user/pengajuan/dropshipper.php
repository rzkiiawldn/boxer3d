<main id="main">
    ...
    <form action="<?= base_url('user/pengajuan/ajukan_dropship'); ?>" method="post" enctype="multipart/form-data">
            ...
            <?php if(!empty($pengajuan->user_id)) { ?>
              <div class="col-md-12">
                <div class="alert alert-primary" role="alert">
                  Proses pengajuan menjadi <strong>dropshipper</strong> di <?= $pengajuan->status_pengajuan; ?>
                </div>
              </div>
            <?php } else { ?>
