                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('admin/syarat/hapus_syarat_return/'.$row->id_syarat); ?>" class="btn btn-sm btn-danger" onclick="confirm('yakin ingin menghapus ?')"><i class="fas fa-trash"></i></a>                            
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
...
<div class="modal fade" id="tambah_syarat" tabindex="-1" role="dialog" aria-labelledby="tambah_syaratLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?= form_open_multipart('admin/syarat/tambah_syarat_return'); ?>
    ...
    <div class="modal fade" id="edit_syarat<?= $row->id_syarat; ?>" tabindex="-1" role="dialog" aria-labelledby="edit_syaratLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url(); ?>admin/syarat/edit_syarat_return/<?= $row->id_syarat; ?>" method="post" enctype="multipart/form-data">
